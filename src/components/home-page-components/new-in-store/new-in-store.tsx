...
import "../new-in-store/new-in-store-styles.css";
import { Splide, SplideSlide } from "@splidejs/react-splide";
import Products from "../new-in-store/new-in-store-products.json";
  ...
  return (
    <div className="new-in-store">
      <div className="category-banner">
        <img className="cat-img" alt="new in store category" src="https://prod-spinneys-cdn-new.azureedge.net/media/images/Strawberry-and-basil-panna-cotta.original.jpg" />
        <div className="cat-overlay">
          <p className="cat-p">
            Stock up on pantry essentials as well as the freshest ingredients.
          </p>
          <button className="view-recipe text-center d-flex justify-content-between" type="button">
            <a className="view-more w-100 d-flex justify-content-evenly text-decoration-none" href="https://www.spinneys.com/en-ae/catalogue/?selected_facets=is_new_exact%3ATrue&sort_by=boost-value">
              View Recipe
              <svg className="view-recipe-svg" xmlns="http://www.w3.org/2000/svg" width="3.558" height="5.707" viewBox="0 0 3.558 5.707">
          ...
          <SplideSlide key={i}>
            <div className="product">
              ...
              <div className="product-info">
                ...
                <p className="name">
                  <a className="name-link" href={product["product-src"]} >
