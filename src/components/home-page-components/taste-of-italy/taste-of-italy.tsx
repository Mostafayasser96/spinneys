...
import "../taste-of-italy/taste-of-italy-styles.css";
import { Splide, SplideSlide } from "@splidejs/react-splide";
import '@splidejs/splide/css';
import '@splidejs/splide/css/core';
import 'bootstrap/dist/css/bootstrap.css';
import Products from "../taste-of-italy/taste-of-italy-products.json";
...
const TasteofItaly = () => {
  ...
  return (
    <div className="taste-of-italy">
      <div className="taste-heading d-flex justify-content-between">
        <div className="titles">
          <p className="title text-left">A taste of Italy</p>
          <p className="subtitle text-#8C8C8C">Shop our range of Italian food and beverage products</p>
        </div>
          ...
          <SplideSlide key={i}>
            ...
            <div className="product-info">
              ...
              <div className="rest">
                ...
                <svg className="italy-arrow-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="30" height="10" focusable="false">
